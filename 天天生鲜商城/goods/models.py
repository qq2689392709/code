...
class GoodsCategory(models.Model):
    ...
    category_front_image = models.ImageField(upload_to='staric/web/images/', null=True, blank=True, verbose_name='封面图')
...
class Click(models.Model):
    ...
    goods_id = models.ForeignKey(Goods, verbose_name='商品id', on_delete=models.CASCADE)
    add_time = models.DateTimeField(auto_now_add=True, verbose_name='添加时间')

    class Meta:
        db_table = 'f_goods_click'
